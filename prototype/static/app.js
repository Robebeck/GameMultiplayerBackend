document.addEventListener("DOMContentLoaded", () => {
    ...
    async function testLogin() {
        ...
        if (!username || !password) {
            addLog("Login failed: username and password are required.", "error");
            return;
        }
        ...
        addLog("Sending login request: " + JSON.stringify(payload, null, 2), "sent");
        ...
        try {
            ...
            addLog("Login request error: " + error.message, "error");
        }
    }
